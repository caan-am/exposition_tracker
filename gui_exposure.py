...
deltas_temp = pd.DataFrame(list({
    ...
    'AMAZON.COM INC': None, 
    'BRK B 28MAR25 515 P': -0.014, 
    'CORE NATURAL RESOURCES INC': None, 
    'CRESUD S.A.-SPONS ADR': None, 
    'ES 17APR25 5480 P': -0.143,
    'ES 17APR25 5670 P': -0.338,
    'GOOGL 28MAR25 157.5 P': -0.057, 
    'HEINEKEN NV': None,
    'HOWARD HUGHES HOLDINGS INC': None,
    'INTEL CORP': None, 
    'LVMH MOET HENNESSY LOUIS VUI': None,
    'MES 20JUN25': None, 
    'MSFT 28MAR25 375 P': -0.028, 
    'NOVO-NORDISK A/S-SPONS ADR': None, 
    'NVO 28MAR25 73 P': -0.872, 
    'PAYPAL HOLDINGS INC': None, 
    'VET 20JUN25 10 P': -0.838,
    'HEIA 28MAR25 74 P': -0.366,
    'SOI 17APR25 57 P': -0.667,
    'YPF 17APR25 37 P': -0.34,
    'GLNG 17APR25 34 P': -0.122,
