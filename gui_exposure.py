...
deltas_temp = pd.DataFrame(list({
    ...
    'AMAZON.COM INC': None, 
    # 'BRK B 28MAR25 515 P': -0.015, 
    'CORE NATURAL RESOURCES INC': None, 
    'CRESUD S.A.-SPONS ADR': None, 
    'ES 17APR25 5480 P': -0.356,
    'ES 17APR25 5670 P': -0.631,
    # 'GOOGL 28MAR25 157.5 P': -0.823, 
    'HEINEKEN NV': None,
    'HOWARD HUGHES HOLDINGS INC': None,
    'INTEL CORP': None, 
    'LVMH MOET HENNESSY LOUIS VUI': None,
    'MES 20JUN25': None, 
    # 'MSFT 28MAR25 375 P': -0.03, 
    'NOVO-NORDISK A/S-SPONS ADR': None, 
    # 'NVO 28MAR25 73 P': -0.975, 
    'PAYPAL HOLDINGS INC': None, 
    'VET 20JUN25 10 P': -0.845,
    # 'HEIA 28MAR25 74 P': -0.213,
    'HEIA 04APR25 74 P': -0.309,
    'SOI 17APR25 57 P': -0.887,
    'YPF 17APR25 37 P': -0.569,
    'GLNG 17APR25 34 P': -0.154,
